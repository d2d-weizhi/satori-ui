        ...
        {colorPalette.map((color, idx) => (
          ...
          >
            ...
            <div className="md:ml-6 flex-1">
              ...
              <div className="text-sm text-slate-700 font-semibold md:text-start text-center">{color.mood}</div>
              <div className="text-sm text-gray-500 mt-1 md:text-start text-center">{color.description}</div>
            </div>
          </div>
        ))}
      </div>
